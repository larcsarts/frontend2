        ...
        <nav>
          <ul className="aside__list">
            ...
            {this.props.isChatVisible ? (
              <li
                className="aside__item-menu"
                onClick={() => {
                  this.props.dispatch(changeChatVisibility(false));
                }}
              >
                FECHAR ATENDIMENTO
              </li>
              ...
              <li
                className="aside__item-menu"
                onClick={() => {
                  this.props.dispatch(changeChatVisibility(true));
                }}
              >
                ABRIR ATENDIMENTO
              </li>
...
const mapStateToProps = ({ users }) => {
  const { isChatVisible, appConfig } = users;
  return { isChatVisible, appConfig };
};
