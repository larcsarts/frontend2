...
import Atendimento, {
  callAtendimento,
} from '../components/verificacao/Atendimento';
...
class Verification extends React.Component {
  ...
  render() {
    const { userProfile, isChatVisible } = this.props;
...
const mapStateToProps = ({ users }) => {
  const { accountVerifications, userProfile, isChatVisible, appConfig } = users;
  return { accountVerifications, userProfile, isChatVisible, appConfig };
};
